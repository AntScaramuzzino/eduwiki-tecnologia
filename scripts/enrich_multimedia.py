...
YT_MAP = {
    ...
    # HUB Scuola — canale ufficiale piattaforma didattica
    "citta-e-urbanistica":                ("0Xxl3KO6dGM", "Abitare il territorio", "HUB Scuola"),
    "costruire-un-edificio-dalle-fondazioni-al-tetto": ("FqVsKq9HV0c", "Costruire", "HUB Scuola"),
    "impianti-dell-abitazione":           ("W_2PiL3xnDM", "L'abitazione", "HUB Scuola"),
    "strutture-portanti-e-sollecitazioni": ("jDKkAAYdFCU", "Strutture edilizie", "HUB Scuola"),
    "materiali-da-costruzione-e-cemento-armato": ("bsSnjCIwPVQ", "I leganti e il cemento armato", "HUB Scuola"),
    "i-metalli-e-le-leghe":               ("bgFojq8m26Q", "I materiali metallici", "HUB Scuola"),
    "proprieta-e-classificazione-dei-materiali": ("EvHPNz_D9S0", "I materiali", "HUB Scuola"),
    "i-nuovi-materiali":                  ("zVgVAxiej34", "I nuovi materiali", "HUB Scuola"),
    "le-fibre-tessili":                   ("CaEeM5hZR_c", "Le fibre tessili", "HUB Scuola"),
    "il-legno":                           ("RnVA2RTTnYE", "Il legno", "HUB Scuola"),
    "il-vetro":                           ("4o9cAZvIBWg", "Il vetro", "HUB Scuola"),
    "la-carta":                           ("Whbm03hVoag", "La carta", "HUB Scuola"),
    "i-materiali-ceramici":               ("PqbrZEdoQtw", "La ceramica", "HUB Scuola"),
    "materie-plastiche-e-gomme":          ("Mapg2wNp2Co", "Le materie plastiche", "HUB Scuola"),
    "grandezze-elettriche-e-circuito":    ("0pTlU6diT6g", "Costruiamo un circuito elettrico", "HUB Scuola"),
    "combustibili-fossili-carbone-petrolio-gas": ("fnxzcLju5Dc", "Estrazione e lavorazione del petrolio", "HUB Scuola"),
    "risparmio-energetico-e-efficienza":  ("2H7cGB8GVQM", "Il risparmio energetico", "HUB Scuola"),
    "sicurezza-elettrica":                ("YnQwrASQBcs", "Il risparmio energetico", "HUB Scuola"),
    "forme-e-trasformazioni-dell-energia": ("uIkh0KMdhAo", "L'energia e le sue forme", "HUB Scuola"),
    "energia-idroelettrica":              ("Sf_08Bach6Y", "L'energia idroelettrica", "HUB Scuola"),
    "centrale-termoelettrica":            ("WEalM-Qckaw", "La centrale termoelettrica", "HUB Scuola"),
    "macchine-semplici-leva":             ("4sUvvPeJW5I", "Le macchine semplici", "HUB Scuola"),
    "trasmissione-del-moto":              ("5yapSn9d5y4", "Macchine e meccanismi", "HUB Scuola"),
    "motori-e-propulsione":               ("CgmxtEs18DI", "Motori e automazioni", "HUB Scuola"),
    "allevamento-e-zootecnia":            ("8l2IHVBTcRg", "Allevamento e pesca", "HUB Scuola"),
    "pesca-e-acquacoltura":               ("irD0yGD1Cf4", "La pesca", "HUB Scuola"),
    "terreno-e-clima-in-agricoltura":     ("erUQdaqtD88", "L'agricoltura", "HUB Scuola"),
    "alimentazione-equilibrata-e-piramide-alimentare": ("a3qQCdjNuWI", "La buona alimentazione", "HUB Scuola"),
    "macchine-e-tecniche-agricole":       ("IQwS0bn9T_E", "La meccanizzazione agricola", "HUB Scuola"),
    "trasformazione-dei-cereali-pane-e-pasta": ("LfUt4FG34CA", "La produzione del pane e della pasta", "HUB Scuola"),
    "filiera-agroalimentare":             ("R0_n6c9CBgE", "Tecnologie alimentari", "HUB Scuola"),
    "latte-e-derivati":                   ("Al0tyMkKvO0", "Una centrale del latte", "HUB Scuola"),
    "agricoltura-sostenibile-e-biologica": ("c-Zym4nw_EA", "I prodotti chimici e l'agricoltura biologica", "HUB Scuola"),
}
