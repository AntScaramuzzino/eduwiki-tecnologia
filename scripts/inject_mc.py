...
MAPPING = {
    ...
    "sensori-e-attuatori":            ["MC-DIG-3-03"],
    # Digitale / Sicurezza
    "social-network-e-cittadinanza-digitale": ["MC-COM-3-02", "MC-COM-3-06"],
    # Disegno tecnico
    "strumenti-del-disegno-tecnico":  ["MC-DIS-1-01"],
    "scale-di-riduzione-e-quotatura": ["MC-DIS-1-02"],
    "proiezioni-ortogonali":          ["MC-DIS-2-01"],
    "assonometrie":                   ["MC-DIS-2-02"],
    "cad-disegno-assistito-dal-computer": ["MC-DIS-3-02"],
    # Materiali
    "proprieta-e-classificazione-dei-materiali": ["MC-MAT-1-01"],
    "riciclo-e-sostenibilita-dei-materiali": ["MC-MAT-1-02", "MC-MAT-1-04"],
    "i-nuovi-materiali":              ["MC-MAT-1-03", "MC-MAT-1-06"],
    "economia-circolare":             ["MC-MAT-1-04"],
    # Agricoltura / Alimentazione
    "agricoltura-sostenibile-e-biologica": ["MC-ALI-2-01"],
    "conservazione-degli-alimenti":   ["MC-ALI-2-02"],
    "etichette-e-sicurezza-alimentare": ["MC-ALI-2-04"],
    "lettura-etichette-alimentari":   ["MC-ALI-2-04"],
    # Edilizia / Abitazione
    "materiali-da-costruzione-e-cemento-armato": ["MC-AMB-2-01"],
    "strutture-portanti-e-sollecitazioni": ["MC-AMB-2-01"],
    "impianti-dell-abitazione":       ["MC-AMB-2-02"],
    "citta-e-urbanistica":            ["MC-AMB-2-03"],
    ...
    "i-settori-produttivi":           ["MC-SIS-3-04"],
    "globalizzazione-ed-economia-sostenibile": ["MC-SIS-3-02"],
    "il-mondo-del-lavoro":            ["MC-SIS-3-03"],
}
